...
void realizaTestes() {
    ...
    // Verificando tamanho lista (todos)

    if (catalogo->quantidadeDeMidias() != 6) {
        throw 7;
    }

    // Verificando tamanho lista 
    // (tipo: CD de música - implementada pela classe CD)
    ...
    // Verificando tamanho lista 
    // (tipo: DVD de filme - implementada pela classe DVD)
    ...
    // Verificando tamanho lista 
    // (tipo: Jogo Eletrônico - implementada pela classe Jogo)

    if (catalogo->quantidadeDeJogos() != 2) {
        throw 10;
    }

    catalogo->removeMidia("Bachianas Brasileiras No.2");

    // Verificando tamanho lista depois remoção
    // (tipo: CD de música - implementada pela classe CD)
    ...
    // Verificando se CD existe
    
    if (catalogo->obtemMidia("Bachianas Brasileiras No.2") != NULL) {
        throw 12;
    }

    catalogo->removeMidia("Matrix");
    ...
    // Verificando se DVD existe
    
    if (catalogo->obtemMidia("Matrix") != NULL) {
        throw 14;
    }
    
    catalogo->removeMidia("Fifa 2008");
    
    // Verificando lista depois remoção
    // (tipo: Jogo Eletrônico - implementada pela classe Jogo)
    ...
    if (catalogo->obtemMidia("Fifa 2018") != NULL) {
        throw 16;
    }
